<x-admin-layout title="Ubah Testimoni">

    <form action="{{ route('testimonials.update', $testimonial) }}" method="POST" class="bg-white p-6 rounded-xl border border-onyx/10 max-w-xl">
        @csrf
        @method('PUT')
